...
pub fn tr(lang: Language, key: &str) -> &'static str {
    match (lang, key) {
        ...
        (Language::Zh, "output_metadata") => "输出元数据",
        (Language::En, "output_metadata") => "Output Metadata",
        (Language::Zh, "output_directory_structure") => "目录结构",
        (Language::En, "output_directory_structure") => "Directory structure",
        (Language::Zh, "output_file_path") => "文件路径标签",
        (Language::En, "output_file_path") => "File path labels",
        (Language::Zh, "output_char_token_counts") => "字符数 / Token 数",
        (Language::En, "output_char_token_counts") => "Character / token counts",
        (Language::Zh, "output_separator") => "分隔线",
        (Language::En, "output_separator") => "Separators",
        ...
        (Language::Zh, "status_overview") => "概览",
        (Language::En, "status_overview") => "Overview",
        (Language::Zh, "statistics") => "统计",
        (Language::En, "statistics") => "Statistics",
        (Language::Zh, "files_count") => "文件数",
        (Language::En, "files_count") => "Files",
        (Language::Zh, "files_unit") => "个文件",
        (Language::En, "files_unit") => "files",
        (Language::Zh, "statistics_by_extension") => "按扩展名",
        (Language::En, "statistics_by_extension") => "By Extension",
        (Language::Zh, "statistics_by_folder") => "按文件夹",
        (Language::En, "statistics_by_folder") => "By Folder",
        (Language::Zh, "largest_files") => "最大文件",
        (Language::En, "largest_files") => "Largest Files",
        (Language::Zh, "smallest_files") => "最小文件",
        (Language::En, "smallest_files") => "Smallest Files",
        (Language::Zh, "no_extension") => "无扩展名",
        (Language::En, "no_extension") => "No extension",
        (Language::Zh, "root_folder") => "根目录",
        (Language::En, "root_folder") => "Root",
        (Language::Zh, "other") => "其他",
        (Language::En, "other") => "Other",
        (Language::Zh, "statistics_empty") => "暂无统计数据",
        (Language::En, "statistics_empty") => "No statistics yet",
        (Language::Zh, "statistics_empty_hint") => "完成内容处理后将在此显示分组图表与文件排行。",
        (Language::En, "statistics_empty_hint") => {
            "Grouped charts and file rankings appear after content processing finishes."
        }
        (Language::Zh, "skip") => "跳过",
        ...
        (Language::Zh, "archive_sources") => "压缩包来源",
        (Language::En, "archive_sources") => "Archive Sources",
        (Language::Zh, "archive_files") => "压缩包",
        (Language::En, "archive_files") => "archives",
        (Language::Zh, "archive_entries") => "展开条目",
        (Language::En, "archive_entries") => "expanded entries",
        (Language::Zh, "archive_badge") => "ZIP",
        (Language::En, "archive_badge") => "ZIP",
        ...
        (Language::Zh, "content_files_title") => "结果文件",
        (Language::En, "content_files_title") => "Result Files",
        (Language::Zh, "content_preview_title") => "内容预览",
        (Language::En, "content_preview_title") => "Content Preview",
        (Language::Zh, "content_files_expand") => "展开文件列表",
        (Language::En, "content_files_expand") => "Show File List",
        (Language::Zh, "content_files_collapse") => "收起文件列表",
        (Language::En, "content_files_collapse") => "Hide File List",
        ...
        (Language::Zh, "archive_path") => "压缩包",
        (Language::En, "archive_path") => "Archive",
        (Language::Zh, "archive_entry_path") => "压缩包内路径",
        (Language::En, "archive_entry_path") => "Archive Entry",
